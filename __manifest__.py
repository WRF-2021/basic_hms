...

{
    ...
    "version" : "12.0.0.4",
    "currency": 'LPS',
    "summary": "help to manage basic Hospital Management",
    "category": "Industries",
    "description": """
...
""" ,
    ...
    "data": [
            ...
            'views/ruta_aborto.xml',
            'views/res_partner.xml',
            'views/medical_patient_vista_familiares.xml',
            'views/ruta_administracion_medicamen.xml',
            'views/ruta_drogas.xml',
            'views/ruta_infertilidad.xml',
